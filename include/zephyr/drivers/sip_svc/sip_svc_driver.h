...
/**
 * @brief Callback API for retrieving transaction id from job id
...
/**
 * @brief Callback API for updating jobid for request packet for lower layer
 ...
 *
 * @retval Job id, which is used for tracking each transaction.
 */
...
/**
 * @brief Retrieve transaction id from job id.
 *
 * @param dev  Pointer to the device structure for the driver instance.
 * @param trans_id Job identifier if for a transaction.
 *
 * @retval transaction id,get transaction id from job id.
 */
...
/**
 * @brief Update job id for sip_svc_request for lower layer.
 *
 * @param dev  Pointer to the device structure for the driver instance.
