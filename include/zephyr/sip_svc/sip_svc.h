 ...
 *
 * @retval 0, on success.
 * @retval -EINVAL, on providing invalid arguments.
 ...
 * @retval 0 ,on success.
 * @retval -EINVAL, on providing invalid arguments.
 * @retval -ETIMEDOUT, on timeout expiry.
 */
 ...
 * @retval -EINVAL, on providing invalid arguments.
 * @retval -EOPNOTSUPP, on invalid command id or function id.
 * @retval -ESRCH, on invalid client state.
 * @retval -ENOMEM, failure to allocate memory.
 * @retval -ENOMSG, failure to insert into database.
 * @retval -ENOBUFS, failure to insert into msgq.
 ...
 * @retval NULL, on invalid arguments and failure to get lock.
 */
 ...
 * @retval NULL, on invalid arguments and on providing unsupported method name.
 */
